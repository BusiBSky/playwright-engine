...
test('test', async ({ page }) => {
  ...
  await page.goto('https://capitecretail0223--uat.sandbox.lightning.force.com/lightning/r/Case/5002600000X5SQzAAN/view?ws=%2Flightning%2Fr%2FAccount%2F0012600002Dpw5iAAB%2Fview', { timeout: 5000000 });
  ...
  await page.getByRole('listitem', { name: 'Details' }, { timeout: 50000000 }).click();
